<template>
  <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
    <div class="mx-auto mb-10 mt-2 sm:text-center">
      <h5 class="tracking-widest text-gray-600 mb-4 md:mx-auto first-animation">MY BACKUP TEAM</h5>
       <h1 class="text-3xl tracking-tight font-extrabold text-gray-900 sm:text-4xl md:text-5xl mb-8 second-animation">
        These are the people I count on when I need new fresh ideas, revision, or simply when I feel stuck.
       </h1>
    </div>
    <div class="grid gap-10 mx-auto lg:grid-cols-2 lg:max-w-screen-lg third-animation">
      <div class="grid sm:grid-cols-3" v-for="(person, index) in team" :key="index">
        ...
        <div class="flex flex-col justify-center mt-5 sm:mt-0 sm:p-5 sm:col-span-2">
          ...
          <p class="mb-4 text-xs text-gray-800">{{ person.occupation }}</p>
