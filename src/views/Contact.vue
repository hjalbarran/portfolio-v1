            ...
            <div class="lg:w-8/12 md:w-7/12 sm:w-6/12 sm:text-center lg:text-justify px-4">
                ...
                <div class="container mx-auto pt-8">
                    <!-- <div class="flex flex-wrap -m-2 third-animation">
                        ...
                        <div class="p-2 w-full">
                            <button class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg" @click="sendEmail($event)">Button</button>
                        </div>
                    </div> -->
...
export default {
  ...
  methods: {
    sendEmail: (e) => {
      emailjs.sendForm('service_bbxwl7k', 'template_9pgeflp', e.target, 'user_swYdziZ2vuZ4jvZHBYsl1')
        .then((result) => {
